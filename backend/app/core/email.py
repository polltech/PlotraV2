...
async def send_cooperative_contact_welcome_email(
    ...
    """
    Send a welcome email to the cooperative contact person with login setup instructions
    ...
    Returns:
        True if email was sent successfully, False otherwise
    """
    subject = f"Welcome to Plotra Platform - Cooperative Contact Person"
    
    text_content = f"""
    Hello {contact_person},
    
    Welcome to the Plotra Platform! You have been designated as the contact person for cooperative "{cooperative_name}".
    ...
    <body>
        <div class="container">
            ...
            <div class="content">
                ...
                <p>Welcome to the Plotra Platform! You have been designated as the contact person for cooperative <strong>"{cooperative_name}"</strong>.</p>
