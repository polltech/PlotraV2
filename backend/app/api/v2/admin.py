...
async def admin_request_farm_update(
    farm_id: str,
    body: dict = {},
    current_user: User = Depends(require_admin),
    db: AsyncSession = Depends(get_db)
):
    """Admin requests farmer to update/correct their farm before final approval."""
...
async def get_system_settings(
    ...
    return {
        "satellite": {
            "provider": db_or("cfg_satellite_provider", "sentinel_hub"),
            "base_url": db_or("cfg_satellite_base_url", "https://services.sentinel-hub.com"),
