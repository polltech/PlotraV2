                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card border-0 shadow-sm h-100">
                        <div class="card-body d-flex flex-column">
                            ...
                            <div class="mt-auto">
                                <button class="btn btn-outline-primary btn-sm me-2" onclick="app.viewFarmDetails(${farm.id})">
                                    <i class="bi bi-eye me-1"></i>View Details
                                </button>
                                <button class="btn btn-outline-success btn-sm" onclick="app.requestSatelliteAnalysis(${farm.id})">
